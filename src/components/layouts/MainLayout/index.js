...
//       <motion.section className={styles.content}>
...
//   const currentIndex = PUBLIC_ROUTES.findIndex((route) => route.path === location.pathname);
//   const previousIndex = PUBLIC_ROUTES.findIndex((route) => route.path === previousPath);
//   const shouldAnimateUp = currentIndex < previousIndex;
//   const exitDirection = shouldAnimateUp ? 1000 : -1000;
...
//         <SideMenu links={PUBLIC_ROUTES} />
//         <TopMenu links={PUBLIC_ROUTES} />
//         <AnimatePresence initial={false} custom={shouldAnimateUp} mode="popLayout" >
//           <motion.div
//             className={styles.children}
//             key={location.key}
//             initial={{ y: shouldAnimateUp ? -1000 : 1000 }}
//             animate={{ y: 0 }}
//             exit={{ y: exitDirection }}
...
//   const currentIndex = PUBLIC_ROUTES.findIndex((route) => route.path === location.pathname);
//   const previousIndex = PUBLIC_ROUTES.findIndex((route) => route.path === previousPathRef.current);
//   const shouldAnimateUp = previousIndex > -1 && currentIndex > -1 && currentIndex < previousIndex;
...
//               className={styles.children}
//               key={location.key}
//               initial={{ x: shouldAnimateUp ? -1500 : 1500 }}
//               animate={{ x: 0 }}
//               exit={{ x: shouldAnimateUp ? 1500 : -1500 }}
//               transition={{ duration: 0.3 }}
//             >
//               {children}
//             </motion.div>
...
//           mode="wait"
//         >
//           <motion.div {...animationProps} layout>{children}</motion.div>
//         </AnimatePresence>
//       </section>
//       <Background />
//     </main>
